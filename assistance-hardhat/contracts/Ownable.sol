...
contract Ownable {
    ...
    modifier onlyAdmin() {
        require(admins[msg.sender] == true || msg.sender == owner, "You are not the owner or an admin");
        _;
    }

    function transferOwnership(address _newOwner) virtual external onlyOwner {
